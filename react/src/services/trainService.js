...
const TRAIN_API_BASE_URL='http://localhost:8100/adminmain/findAllTrains'
const ADD_TRAIN_API_BASE_URL='http://localhost:8100/adminmain/addTrain'
const UPDATE_TRAIN_API_BASE_URL='http://localhost:8100/adminmain/update'
const DELETE_TRAIN_API_BASE_URL='http://localhost:8100/adminmain/deletetrain'
